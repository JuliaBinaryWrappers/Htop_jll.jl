...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Htop_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3902149a-7cde-5d36-8de2-61bc48a40c47"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Htop", artifacts_toml) for e in artifacts["Htop"]]
...
if best_platform === nothing
    @debug("Unable to load Htop; unsupported platform $(triplet(platform_key_abi()))")
else
